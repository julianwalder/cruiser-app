...
export const UserLayout: React.FC<UserLayoutProps> = ({ 
  ...
  const menuItems: MenuItem[] = [
    ...
    { id: 'onboarding', label: 'Onboarding', icon: Icons.Profile },
  ...
  return (
    <>
      <Helmet>
        <title>User Dashboard - Cruiser Aviation Platform</title>
        <meta name="description" content="User dashboard for Cruiser Aviation Platform" />
      </Helmet>
